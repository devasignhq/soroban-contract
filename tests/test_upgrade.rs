...
use test_config::TestValidation;
...
#[test]
fn test_version() {
    let (_env, _admin, _usdc_address, _usdc_token, _usdc_token_client, _contract_id, client) =
        create_test_env();
...
fn test_version_is_static() {
    ...
    let (_env1, _admin1, _usdc_address1, _usdc_token1, _usdc_token_client1, _contract_id1, client1) =
        create_test_env();

    let (_env2, _admin2, _usdc_address2, _usdc_token2, _usdc_token_client2, _contract_id2, client2) =
        create_test_env();
